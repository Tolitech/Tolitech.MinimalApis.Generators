...
namespace Tolitech.MinimalApis.Generators;
...
public class Generator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(combined, (spc, source) =>
        {
            ...
            var endpointDefSymbol = compilation.GetTypeByMetadataName("Tolitech.MinimalApis.Generators.Abstractions.IEndpoint");
            ...
            sb.AppendLine("// <auto-generated />")
                ...
                .AppendLine()
                .AppendLine("namespace Tolitech.MinimalApis.Generators;")
                .AppendLine()
                .AppendLine("/// <summary>")
            ...
            foreach (string? impl in endpointImplementations.Distinct().OrderBy(x => x))
            {
